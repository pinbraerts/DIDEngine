...
#define __DEBUG_USING_3(ID, WHICH, VALUE) std::wstring __DEBUG_TEM_##WHICH##ID = __DEBUG_##WHICH; __DEBUG_##WHICH = VALUE
...
#define __DEBUG_USING_7(ID, WHICH1, VALUE1, WHICH2, VALUE2, WHICH3, VALUE3) __DEBUG_USING_3(ID, WHICH1, VALUE1); __DEBUG_USING_3(ID, WHICH2, VALUE2); __DEBUG_USING_3(ID, WHICH3, VALUE3)
...
#define __DEBUG_USING_9(ID, WHICH1, VALUE1, WHICH2, VALUE2, WHICH3, VALUE3, WHICH4, VALUE4) __DEBUG_USING_3(ID, WHICH1, VALUE1); __DEBUG_USING_3(ID, WHICH2, VALUE2); __DEBUG_USING_3(ID, WHICH3, VALUE3); __DEBUG_USING_3(ID, WHICH4, VALUE4)
